...
public class ProductController {
	...
	public Response<GetProductRes> getProduct(
		...
		GetProductRes response = productService.getProduct(currentUser.getId(), storeId, productId);
		return Response.ok(response);
	}
	...
	public Response<Page<PageProductRes>> getProductByKeyword(
		...
		Page<PageProductRes> response =
			productService.getProductByKeyword(currentUser.getId(), storeId, keyword, pageable);
