...
public class OrderHistoryController {
    ...
    public Response<List<GetOrderRes>> getOrder(
        ...
        return Response.ok(orderHistoryService.findOrder(orderId, authUser.getId()));
    }
    ...
    public Response<Page<GetOrderRes>> getOrders(
        ...
        return Response.ok(orderHistoryService.getOrders(pageNum, pageSize, authUser.getId()));
    }
}
