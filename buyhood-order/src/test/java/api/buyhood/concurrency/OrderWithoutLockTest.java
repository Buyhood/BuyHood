...
import api.buyhood.order.BuyHoodOrderApplication;
...
import static api.buyhood.order.enums.PaymentMethod.CARD;
import static api.buyhood.errorcode.ProductErrorCode.PRODUCT_NOT_FOUND;

@SpringBootTest(classes = BuyHoodOrderApplication.class)
public class OrderWithoutLockTest {
    ...
    //seller
    public static final User TEST_SELLER = new User("seller", "seller@seller.com", "password", "사업자 번호", "전화번호");

    //store
    public static final Long TEST_STORE_ID = 1L;
    public static final Long TEST_STORE_CATEGORY_ID = 1L;
    public static final Store TEST_STORE = new Store("가게", "주소", TEST_SELLER.getId(),TEST_STORE_CATEGORY_ID,true, "설명", LocalTime.parse("08:00:00"), LocalTime.parse("22:00:00"));

    //product
    public static final Long TEST_PRODUCT_ID = 1L;
    public static final Long TEST_STOCK = 100L;
    public static final Product TEST_PRODUCT = new Product("제품", 100L, "설명", TEST_STOCK, TEST_STORE.getId());
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(TEST_SELLER, "role", UserRole.SELLER);
